...
Use one authoritative editing session per project file. Cross-process file locks,
compare-and-swap saves, remote authentication and retry idempotency remain future work.
